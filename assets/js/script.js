...
function getLocation(event) {
   var inputAttriute = event.target.getattribute('user-value');
    var requestURL = 'https://api.openweathermap.org/geo/1.0/direct?q=' + inputAttriute + '&APPID=3499423db588f95e559c805825019d12';
