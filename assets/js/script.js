...
function callback(data) {
  ...
  */
  ...
  function getCoordinates(searchQuery) {
    ...
    const apiUrlQuery = 'https://api.openweathermap.org/geo/1.0/direct?q=' + searchQuery + '&limit=5&appid=87f0de1bffacb365cee10726cee3b895';
  ...
  function getResults(lat, long, updateSearchHistory) {
    ...
    let currentApi = 'https://api.openweathermap.org/data/2.5/weather?lat=' + lat + '&lon=' + long + '&lang=en&appid=87f0de1bffacb365cee10726cee3b895&units=imperial';
    ...
    fetch(currentApi, {
      ...
      // Forcast API call
      // Forcast call
      let forcastApiUrl = 'https://api.openweathermap.org/data/2.5/forecast?lat=' + lat + '&lon=' + long + '&lang=en&appid=87f0de1bffacb365cee10726cee3b895&units=imperial';
        fetch(forcastApiUrl, {
          cache: 'reload'
          })
          .then(function (response) {
